...
import com.moko.empty.BaseApplication;
...
public class Utils {
    ...
    public static File getFile(String fileName) {
        String devicePath = BaseApplication.PATH_LOGCAT + File.separator + fileName;
    ...
    public static void sendEmail(Context context, String address, String body, String subject, String tips, File... files) {
        ...
        if (files.length == 1) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                uri = FileProvider.getUriForFile(context, "com.moko.empty.fileprovider", files[0]);
